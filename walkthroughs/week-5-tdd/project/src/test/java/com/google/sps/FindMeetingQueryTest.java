...
public final class FindMeetingQueryTest {
  ...
  public void justEnoughRoomOpt() {
    // Opt attendee should be ignored because time slot would be too small
  ...
  @Test
  public void noMandAttendees1() {
  // Have each opt attendee have different events. Should see multiple meeting times throughout day
  //
  // Events  :       |--A--|     |--B--|
  // Day     : |-----------------------------|
  // Options : |--1--|     |--2--|     |--3--|
  ...
  @Test
  public void noMandAttendees2() {
  // Have each opt attendee have all day events. Should see no available times.
